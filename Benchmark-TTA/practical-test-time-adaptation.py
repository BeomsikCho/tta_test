...
from src.data import load_practical_dataset
...
def evaluate(cfg):
    ...
    for i_dom, domain_name in enumerate(dom_names_loop):
        ...
        for severity in severities:
            testset, test_loader = load_practical_dataset(
                ...
                gamma=cfg.TEST.GAMMA, # practical_tta에서만 넣어줘야 하는 input
                slots=cfg.TEST.SLOTS # practical_tta에서만 넣어줘야 하는 input
            )
