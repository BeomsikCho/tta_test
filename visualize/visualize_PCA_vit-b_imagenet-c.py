...
#    (t-SNE -> PCA로 대체)
# -----------------------------------------------------------
save_dir = f"results/PCA/{DATASET}/{MODEL_NAME}"
...
# -----------------------------------------------------------
# 6) PCA
#    (기존 t-SNE 부분을 PCA로 교체)
# -----------------------------------------------------------
print("\n[INFO] Running a single PCA on ALL data...")
...
plt.title(f"All Classes & Domains in One PCA ({MODEL_NAME})")
plt.legend(fontsize=8, bbox_to_anchor=(1.05, 1), loc='upper left')
plt.tight_layout()

save_path = os.path.join(save_dir, "all_in_one_pca.jpg")
